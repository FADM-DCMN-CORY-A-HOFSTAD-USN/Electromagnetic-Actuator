...
-   **Plasma Confinement:** The control logic ensures that the Maxwell force is applied exactly when the UV amplitude is at its peak, using the 5-microsecond standard as the synchronization pulse for the entire rig.
